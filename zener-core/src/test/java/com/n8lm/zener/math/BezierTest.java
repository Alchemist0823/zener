...
public class BezierTest {
    ...
    public void testBezierFunctionAddDisordered() {
        ...
        editableCurveFunction.addAnchor(new EditableAnchorData(new Vector2f(0.0f, 0.0f), new Vector2f(-1.0f, 0.0f), new Vector2f(1.0f, 0.0f)));
        editableCurveFunction.addAnchor(new EditableAnchorData(new Vector2f(4.0f, 0.0f), new Vector2f(3.0f, 0.0f), new Vector2f(5.0f, 0.0f)));
        editableCurveFunction.addAnchor(new EditableAnchorData(new Vector2f(2.0f, 2.0f), new Vector2f(1.0f, 2.0f), new Vector2f(3.0f, 2.0f)));
    ...
    public void testBezierFunctionValidation() {
        ...
        EditableCurveFunction editableCurveFunction = new EditableCurveFunction();
        editableCurveFunction.addAnchor(new EditableAnchorData(new Vector2f(0.0f, 0.0f), new Vector2f(-10.0f, 0.0f), new Vector2f(10.0f, 0.0f)));
        editableCurveFunction.addAnchor(new EditableAnchorData(new Vector2f(2.0f, 2.0f), new Vector2f(-10.0f, 2.0f), new Vector2f(10.0f, 2.0f)));
        editableCurveFunction.addAnchor(new EditableAnchorData(new Vector2f(4.0f, 0.0f), new Vector2f(-10.0f, 0.0f), new Vector2f(10.0f, 0.0f)));
