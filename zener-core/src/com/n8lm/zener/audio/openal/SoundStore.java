...
import com.n8lm.zener.audio.openal.MODSound;
...
public class SoundStore {
  ...
  /**
   * The tiledMap of references to IDs of previously loaded sounds
   */
  @Nonnull
   ...
   */
  @Nonnull
  public Audio getMOD(@Nonnull String ref, @Nonnull final ResourceManager resourceLoader) throws IOException {
   ...
   */
  @Nonnull
  public Audio getAIF(@Nonnull String ref, @Nonnull final ResourceManager resourceLoader) throws IOException {
   ...
   */
  @Nonnull
  public Audio getWAV(@Nonnull String ref, @Nonnull final ResourceManager resourceLoader) throws IOException {
   ...
   */
  @Nonnull
  public Audio getOggStream(String ref, final ResourceManager resourceLoader) throws IOException {
    if (!soundWorks || sources == null) {
      return new NullAudio();
    }
   ...
   */
  @Nonnull
  public Audio getOgg(@Nonnull String ref, @Nonnull final ResourceManager resourceLoader) throws IOException {
