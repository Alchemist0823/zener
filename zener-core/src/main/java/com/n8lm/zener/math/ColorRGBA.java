...
public final class ColorRGBA implements Cloneable, java.io.Serializable {
     ...
     */
    public void clamp() {
        r = MathUtil.clamp(r, 0f, 1f);
        g = MathUtil.clamp(g, 0f, 1f);
        b = MathUtil.clamp(b, 0f, 1f);
    ...
    public static ColorRGBA randomColor() {
        ...
        rVal.r = MathUtil.nextRandomFloat();
        rVal.g = MathUtil.nextRandomFloat();
        rVal.b = MathUtil.nextRandomFloat();
        return rVal;
    }
