...
public class Sound {
   ...
   * @throws Exception Indicates a failure to load the sound effect
   */
   ...
   * @throws Exception Indicates a failure to load the sound effect
   */
  public Sound(@Nonnull String ref, @Nonnull final ResourceManager resourceLoader) throws Exception {
    SoundStore.get().init();
