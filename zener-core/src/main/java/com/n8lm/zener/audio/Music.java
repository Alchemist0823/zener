...
import com.n8lm.zener.audio.openal.AudioImpl;
...
public class Music {
   ...
   */
  @Nonnull
  private final ArrayList<MusicListener> listeners = new ArrayList<MusicListener>();
  /**
   ...
   * @throws Exception
   */
  public Music(@Nonnull String ref, @Nonnull final ResourceManager resourceLoader) throws Exception {
   ...
   * @throws Exception
   */
  /*public Music(@Nonnull URL ref, final ResourceManager resourceLoader) throws Exception {
    this(ref, false, resourceLoader);
  }*/
   ...
   * @throws Exception
   */
  public Music(@Nonnull URL url, boolean streamingHint) throws Exception {
    SoundStore.get().init();
  ...
  public Music(
      ...
      @Nonnull final ResourceManager resourceLoader) throws Exception {
    SoundStore.get().init();
