...
public class StreamSound extends AudioImpl {
	...
	private final static Logger LOGGER = Logger.getLogger(StreamSound.class
			.getName());
	...
	public int playAsMusic(float pitch, float gain, boolean loop) {
		try {
			...
			LOGGER.log(Level.SEVERE,
					"Failed to read OGG source: " + player.getSource());
		}
	...
	/**
	 * @see com.n8lm.zener.audio.AudioImpl#playAsSoundEffect(float, float,
	...
	/**
	 * @see com.n8lm.zener.audio.AudioImpl#setPosition(float)
	 */
	...
	/**
	 * @see com.n8lm.zener.audio.AudioImpl#getPosition()
	 */
